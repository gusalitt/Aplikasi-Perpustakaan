<?php
  ...
  $data_sql = "SELECT pm.*, b.*
          FROM peminjaman_buku pm
          INNER JOIN buku b ON pm.id_buku = b.id_buku
          WHERE pm.id_buku = ? AND pm.id_pengguna = ? AND pm.status = 'Dipinjam'";
...
<section class="book-details-peminjaman">
  <div class="details-header">
    ...
    <div class="details-content">
      <div class="tabs" role="tablist">
        <button role="tab" aria-selected="true" aria-controls="panel1" id="tab1">Peminjaman</button>
      ...
      <div role="tabpanel" id="panel1" aria-labelledby="tab1">
        ...
        <p>Tgl Peminjaman : <span><?= date("d/M/Y", strtotime($row['tgl_peminjaman'])); ?></span></p>
        <p>Batas Waktu Peminjaman : 7 hari - <span><?= date("d/M/Y", strtotime($row['batas_waktu'])); ?></span></p>
        <p>Status : <span>Dipinjam</span></p>
        <p>NB : <span>Dikenakan denda Rp. 2.000,00/hari jika pengembalian buku lewat dari batas waktu peminjaman.</span></p>
